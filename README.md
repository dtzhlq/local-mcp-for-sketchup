...
```json
{
  "runtime": {
    ...
    "manifest_version": "2026-05-phase2-product-boolean-slice",
    "dsl_version": 1,
    "supported_operations": ["reset", "material", "box"],
    "compatibility": {
      "ok": true,
      "level": "ok",
      "checked_against": { "manifest_version": "2026-05-phase2-product-boolean-slice", "capability_version": "0.1.0-capabilities.1", "dsl_version": 1 },
      "issues": []
    }
  },
