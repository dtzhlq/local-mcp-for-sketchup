...
assert.equal(report.face_edge_editable, false);

process.stdout.write(`${JSON.stringify({ ok: true, definition_wide_instances: 2, make_unique_instances: 1, face_edge_editable: false }, null, 2)}\n`);
