...
module LocalMcpForSketchUp
  ...
  def add_image_plane(parent_entities, operation)
    ...
    group.set_attribute('LocalMcpForSketchUp', 'image', operation['image'] || operation['texture']) if operation['image'] || operation['texture']
    group.set_attribute('LocalMcpForSketchUp', 'plane', plane)
  ...
  def add_text_emboss(parent_entities, operation)
    ...
    group = parent_entities.grep(Sketchup::Group).last
    group.set_attribute('LocalMcpForSketchUp', 'glyphs', marker[:glyphs]) if group&.respond_to?(:set_attribute)
  end
  ...
  def add_font_outline_text_marker(parent_entities, operation, kind, direction, default_material)
    ...
    if group.respond_to?(:set_attribute)
      ...
      group.set_attribute('LocalMcpForSketchUp', 'glyphs', glyphs)
  ...
  def add_slot_array(parent_entities, operation)
    ...
    group = parent_entities.grep(Sketchup::Group).last
    if group&.respond_to?(:set_attribute)
      group.set_attribute('LocalMcpForSketchUp', 'count', count)
      group.set_attribute('LocalMcpForSketchUp', 'segments', segments)
      group.set_attribute('LocalMcpForSketchUp', 'direction', direction)
    end
  end
