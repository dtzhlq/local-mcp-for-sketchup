...
const contracts={
 ...
 prepare_existing_model_edit:obj({kind:{const:'prepare_existing_model_edit'},plan,approval_challenge:nullable(map),copy_fast_session:nullable(map),artifacts:map}),
...
plan.required=['kind','plan_id','plan_hash','model_revision','dsl_document','blockers'];
