...
export function validateGeometryEdits(edits){
  try{
    ...
    for(const e of edits){
      ...
      if(!schema||Object.keys(e).some(k=>!Object.hasOwn(schema.properties,k))||schema.required.some(k=>e[k]===undefined))throw new Error('Unknown edit, field, or missing required argument');
