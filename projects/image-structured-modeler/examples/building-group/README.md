...
- generated artifacts: `observations.json`, per-image `review-overlays/*-overlay.png`, `part-graph.massing.json`, `output.massing.json`, `layout-qa/*`, `reference-visual-qa/*`, `layout-qa-queue/*`, `reference-visual-qa-queue/*`, `proposal-review/*`, `proposal-qa/*`, and `proposal-qa-queue/*`
