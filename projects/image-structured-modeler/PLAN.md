...
1. 继续 R7 建筑群照片建模：基于已通过 mock/live queue 的 `building_group` detail proposals，把 facade/roof/opening 规则接入更强的 Reference Visual QA。
