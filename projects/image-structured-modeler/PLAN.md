...
1. 进入真实照片/oblique dense boundary：第二个生成建筑群样本已作为 Grounding v2/Grounding v3 泛化门跑通；下一步用真实照片或更强 oblique cues 验证 facade/height/photo-grade 失败门槛，且必须先通过 ScaleAnchorGraph、GroundPlan、line/grid residual 和 TopViewOverlay QA。
